...
// Initialize TomeConnectorProxy
const proxy = new TomeConnectorProxy({
  robotCopy,
  enableHealthChecks: true,
  enableMetrics: true
});

// Initialize OpenTelemetry with the proxy
const otel = new TomeConnectorOpenTelemetry(proxy, {
