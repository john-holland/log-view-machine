...
public class Spelunk {
    ...
    private final Boolean isModableCave;
    ...
    public Spelunk(
        ...
        this.isModableCave = isModableCave;
    }
    ...
    public Boolean getIsModableCave() { return isModableCave; }
    ...
    public static class Builder {
        ...
        public Builder isModableCave(Boolean isModableCave) { this.isModableCave = isModableCave; return this; }
        public Spelunk build() {
            return new Spelunk(childCaves, tomes, route, container, renderKey, tomeId, docker, subdomains, isModableCave);
        }
    }
}
