...
// TomeManager exports
export { TomeManager, createTomeManager } from './core/Cave/tome/TomeManager';
...
export { escapeText, unescapeText, parseHtml, } from './core/sanitize/scriptInjectionPrevention';
// Message token (CSRF-style) for cross-boundary Cave/Tome/VSM
export { generateToken, generateTokenAsync, validateToken, serializeToken, parseToken, } from './core/messaging/MessageToken';
// Cave messaging transport (extension content/background/popup)
export { createInMemoryTransport, wireInMemoryTransportPair, } from './core/messaging/CaveMessagingTransport';
// Monitoring (AWS/Hystrix-compatible metrics)
export { createDefaultResourceMonitor, createMetricsReporter, DefaultResourceMonitor, } from './core/monitoring';
// Resilience (circuit breaker, throttle)
export { CircuitBreaker, createCircuitBreaker, ThrottlePolicy, createThrottlePolicy, } from './core/resilience';
