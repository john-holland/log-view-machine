 ...
 */
import type { NormalizedRequest, NormalizedRequestHandler, NormalizedMiddleware, RouteHandlerBag } from './types';
/**
...
export interface CaveServerContext {
    ...
    tomeManagerRef?: {
        current: import('../Cave/tome/TomeConfig').TomeManager | null;
    };
    /**
