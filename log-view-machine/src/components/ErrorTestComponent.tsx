...
const ErrorTestComponent: React.FC<ErrorTestComponentProps> = ({ shouldError = false }) => {
  ...
  if (triggerError && errorType === 'render') {
    throw new Error('🚨 Render Error: This is a simulated render error in the ErrorTestComponent');
  }
  ...
  return (
    <div className="error-test-component">
      <div className="test-header">
        ...
        <p>This component is designed to test the error boundary functionality.</p>
      </div>
      ...
      <div className="test-description">
        <h4>How Error Boundaries Work:</h4>
        <ul>
